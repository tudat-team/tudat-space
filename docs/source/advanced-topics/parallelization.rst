...
</getting-started/examples/tudatpy-examples/propagation/keplerian_satellite_orbit.ipynb>`. Using
...
</getting-started/examples/tudatpy-examples/propagation/keplerian_satellite_orbit.ipynb>`, with the small
