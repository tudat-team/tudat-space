...
full propagation, as opposed to its separate arcs. The reader is referred to the :ref:`API documentation <tudatpy:index_tudatpy>` for more details. A small example is shown below:
