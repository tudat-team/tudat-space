...
</examples/tudatpy-examples/mission_design/hodographic_shaping_mga_optimization.ipynb>` and adapted
...
</examples/tudatpy-examples/mission_design/hodographic_shaping_mga_optimization.ipynb>` but
